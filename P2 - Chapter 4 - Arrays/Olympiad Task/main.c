...
int main() {
    char originalGrid[GRID_HEIGHT][GRID_WIDTH] = {{'R', 'R', 'G', 'B'},
                                                  {'G', 'R', 'B', 'G'},
                                                  {'R', 'R', 'G', 'B'},
                                                  {'G', 'B', 'R', 'B'}};

    char currentgrid[GRID_HEIGHT][GRID_WIDTH];
    memcpy(currentgrid, originalGrid,
           sizeof(char) * GRID_WIDTH * GRID_HEIGHT);
